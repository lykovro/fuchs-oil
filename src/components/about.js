...
const About = () => {
  ...
  const directionsData = [
    ...
    { title: 'Пластичные смазки', description: 'Информация о консистентных смазках...' },
    { title: 'Смазочные материалы для обработки металлов', description: ['Этот сегмент включает смазочно охлаждающие технологические составы, продукты для защиты от коррозии и термической обработки и многое другое.', 'ООО «НОССА» предлагает весь спектр смазочных материалов FUCHS для обработки металлов:', '- Смазочно‑охлаждающие жидкости для обработки металлов резанием (СОЖ)', '- Масла для направляющих скольжения, цепей и пневмоинструмента', '- Смазочно-охлаждающие средства для обработки металлов давлением (ОМД)', '- Закалочные жидкости', '- Промышленные очистители', '- Антикоррозионные составы']  },
            ...
            <div className='about_title'>
                ...
                <div className="about_text">   
                    <p className="super-brief-statement">
                        ...
                        <br></br><span>В составе группы <span className="cosmic-highlight">FUCHS</span> насчитывается около 60 компаний и 6000 сотрудников по всему миру, в том числе в России в <a className='about_text_a' href="https://www.fuchs-oil.ru/production/">г. Калуга</a>, а сама группа <span className="cosmic-highlight">FUCHS</span> является мировым лидером среди независимых производителей смазочных материалов.</span>
