...
const TermaObrabotka = () => {
    ...
    return (
        ...
        <div className="product-section-with-images">
          ...
          <p className="product-title-text-style"><a href=""><Link to='/catalog/industrial_smasochnie_materials/product_dlya_termicheskoy_obrabotki'>Продукты для термической обработки</Link></a></p>
        </div>
        <div className="catalog-container">
          <h2 className="catalog-title">Продукты для термической обработки</h2>
                  ...
                  <div className="vehicle-info-card-motor-masla">
                    <div className="transport-card-motor-masla">
                      ...
                      <div className="transport-info-card-motor-masla">
                        <p className="transport-heading-style-motor-masla">Закалочные масла THERMISOL</p>
              ...
              <a href="">
                <div className="vehicle-info-card-motor-masla">
                  <div className="transport-card-motor-masla">
                    ...
                    <div className="transport-info-card-motor-masla">
                      <p className="transport-heading-style-motor-masla">Водосмешиваемые полимерные закалочные жидкости THERMISOL</p>
                      <p className="transport-details-button-text-motor-masla">Подробнее</p>
                    </div>
                  </div>
                </div>
