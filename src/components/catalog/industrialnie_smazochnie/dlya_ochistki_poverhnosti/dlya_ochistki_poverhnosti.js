...
const OchistkaPoverh = () => {
    ...
    return (
        ...
        <div className="product-section-with-images">
          ...
          <p className="product-title-text-style"><a href=""><Link to="/catalog/industrial_smasochnie_materials/ochistiteli_i_antikorrozionnye_sostavy_ochistiteli_vodosmeshivaemye">Продукты для очистки поверхности</Link></a></p>
        </div>
        <div className="catalog-container">
          <h2 className="catalog-title">Продукты для очистки поверхности</h2>
