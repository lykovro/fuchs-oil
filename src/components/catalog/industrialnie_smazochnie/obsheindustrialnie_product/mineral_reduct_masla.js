...
const MineralReduktMasla = () => {
    ...
    return (
        ...
        <div className="product-section-with-images">
          ...
          <p className="product-title-text-style"><a href=""><Link to="/catalog/industrial_smasochnie_materials/obsheindustrial_product/masla_na_mineralnoy_osnove">Минеральные редукторные масла</Link></a></p>
        </div>
        <div className="catalog-container">
          <h2 className="catalog-title">Минеральные редукторные масла</h2>
...
export default MineralReduktMasla;