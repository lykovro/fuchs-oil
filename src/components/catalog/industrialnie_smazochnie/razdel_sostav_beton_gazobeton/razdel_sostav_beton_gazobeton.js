...
const BetonGazobeton = () => {
    ...
    return (
        ...
        <div className="product-section-with-images">
          ...
          <p className="product-title-text-style"><a href=""><Link to="/catalog/industrial_smasochnie_materials/razdelitelnye_sostavy_dlya_betona_i_gazobetona">Разделительные составы для бетона и газобетона</Link></a></p>
        </div>
        <div className="catalog-container">
          <h2 className="catalog-title">Разделительные составы для бетона и газобетона</h2>
