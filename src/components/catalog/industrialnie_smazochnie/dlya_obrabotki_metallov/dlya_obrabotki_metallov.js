...
const ObrabotkaMetallov = () => {
    ...
    return (
        ...
        <div className="product-section-with-images">
          ...
          <p className="product-title-text-style"><a href=""><Link to='/catalog/industrial_smasochnie_materials/produkty_dlya_obrabotki_metallov_davleniem'>Продукты для обработки металлов давлением</Link></a></p>
        </div>
        <div className="catalog-container">
          <h2 className="catalog-title">Продукты для обработки металлов давлением</h2>
...
export default ObrabotkaMetallov;