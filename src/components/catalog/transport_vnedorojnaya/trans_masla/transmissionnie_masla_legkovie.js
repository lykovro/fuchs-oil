...
const TransMaslaLegkovie = () => {
    ...
    return (
        ...
        <div className="product-section-with-images">
          ...
          <p className="product-title-text-style"><a href=""><Link to="/catalog/transport_vnedorojnaya/transmissionie_masla/dlya_legkovykh_avtomobiley">Трансмиссионные масла для легковых автомобилей</Link></a></p>
        </div>
        <div className="catalog-container">
          <h2 className="catalog-title">Трансмиссионные масла для легковых автомобилей</h2>
...
export default TransMaslaLegkovie;