...
const MotorMaslaGruzovie = () => {
    ...
    return (
        ...
        <div className="product-section-with-images">
          ...
          <p className="product-title-text-style"><a href=""><Link to="/catalog/transport_vnedorojnaya/motor_masla/gruzovie_avto">Моторные масла для для грузовых автомобилей</Link></a></p>
        </div>
        <div className="catalog-container">
          <h2 className="catalog-title">Моторные масла для для грузовых автомобилей</h2>
...
export default MotorMaslaGruzovie;